import { setupCanvas } from '../my-utils';
import * as twgl from 'twgl.js';
import { m4 } from 'twgl.js';
import * as flattenedPrimitives from './flatten-primitives';
...
function main() {
  ...
  for (let ii = 0; ii < numObjects; ++ii) {
    ...
    const object = {
      uniforms: {
        u_colorMult: [Math.random(), Math.random(), Math.random(), 1.0],
